...
<head>
    ...
    <title>Formosa Kappa - Contact Us</title>
...
<body>
        ...
        <div class="contact-container">
            <div class="contact-info">
                <div class="info-card">
                    ...
                    <h3>Visit Us</h3>
                    <p>123 kulanari Avenue<br>Food District, City 12345</p>
                </div>
                ...
                <div class="info-card">
                    ...
                    <h3>Email Us</h3>
                    <p>info@formosakappa.com<br>reservations@formosakappa.com</p>
                </div>

                <div class="info-card">
                    <div class="info-icon">🕒</div>
                    <h3>Opening Hours</h3>
                    <p>Mon - Fri: 07:00 AM - 11:00 PM<br>
                    Sat - Sun: 08:00 AM - 11:00 PM</p>
                </div>
            </div>
    ...
    <footer>
        <p>&copy; 2025 Formosa Kappa. All rights reserved.</p>
    </footer>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Formosa Kappa- Login</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <nav>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Formosa Kappa - Home</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <nav>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Formosa Kappa - Menu</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <nav>
        ...
        <div class="menu-grid">
            <div class="menu-item">
                ...
                <div class="menu-item-content">
                    ...
                    <p>A rich, savory broth with tender braised beef, wheat noodles, and pickled greens.</p>
            ...
            <div class="menu-item">
                ...
                <div class="menu-item-content">
                    <h3>Lu Rou Fan</h3>
                    <p>Steamed rice topped with slow-braised minced pork in a sweet-salty soy sauce</p>
            ...
            <div class="menu-item">
                ...
                <div class="menu-item-content">
                    <h3>Gua Bao</h3>
                    <p>A fluffy steamed bun filled with braised pork belly, pickled mustard greens, and peanuts.</p>
            ...
            <div class="menu-item">
                ...
                <div class="menu-item-content">
                    <h3>Oyster Omelet</h3>
                    <p>A chewy egg omelet with fresh oysters, greens, and a sweet-savory sauce</p>
            ...
            <div class="menu-item">
                ...
                <div class="menu-item-content">
                    <h3>Stinky Tofu</h3>
                    <p>Fermented tofu deep-fried or steamed, known for its strong aroma and crispy texture.</p>
            ...
            <div class="menu-item">
                ...
                <div class="menu-item-content">
                    ...
                    <p>Chicken braised with soy sauce, sesame oil, and rice wine, finished with basil.</p>
...
## OUTPUT:
![alt text](Screenshot_24-12-2025_102758_127.0.0.1.jpeg)
![alt text](Screenshot_24-12-2025_102812_127.0.0.1.jpeg)
![alt text](Screenshot_24-12-2025_102823_127.0.0.1.jpeg)
![alt text](Screenshot_24-12-2025_102834_127.0.0.1.jpeg)
